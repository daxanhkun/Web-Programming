...
from .models import Doctor, OrderItem, Order, Address, Payment, Coupon, Refund, UserProfile, Specialty, Booking
    ...
    def post(self, *args, **kwargs):
        ...
        try:
            if form.is_valid():
                ...
                booking = Booking.objects.create(examination_date=examination_date, user=self.request.user, total=doctor.price)
                if payment_option == 'P':
